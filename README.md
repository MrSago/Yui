...
1. Вывод гильдейских убийств боссов с отображением списка топ ДПС, топ ХПС и скриншотом лута.
...
2. Установить необходимые каналы
   ...
   2.2 `/lootfilter` - настройка фильтра рейдов и боссов. Больше информации после вызова команды.

   2.3. `/setchangelog [channel]` - устанавливает канал для вывода списка изменений
   - channel - канал для вывода сообщений.
