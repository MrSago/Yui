...
**Возвращает:** `Promise<Object|null>` - объект ответа API с данными изменений или null при ошибке
...
**Возвращает:** `Promise<Object|null>` - объект ответа API с убийствами боссов и экземплярами или null при ошибке
