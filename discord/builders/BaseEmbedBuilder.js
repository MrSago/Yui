...
/**
 * Base Embed Builder
 * Provides common embed building functionality
 */
class BaseEmbedBuilder {
   ...
   * @returns {EmbedBuilder}
   */
  static addEmptyInlineFields(embed) {
    return embed.addFields(
      {
        name: "\u200b",
        value: "\u200b",
   ...
   */
  static splitContent(content, maxLength = 4096) {
...
module.exports = BaseEmbedBuilder;
