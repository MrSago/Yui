...
Единое интерактивное меню настройки бота.

**Описание:** открывает панель с выбором раздела настроек (changelog/loot/loot filters), каналами, кнопками сброса, формой ввода параметров loot и отдельной категорией для настройки loot-фильтров.
